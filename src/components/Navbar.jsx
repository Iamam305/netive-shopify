...
const Navbar = ({ userInfo, hamburger, setHamburger }) => {
  ...
  return (
    <>
      <header className="flex flex-row-reverse md:flex-row items-center w-full md:w-[calc(100%_-_16rem)] fixed z-40 justify-between h-16 px-6 py-2 bg-white border-b-4 border-indigo-500">
