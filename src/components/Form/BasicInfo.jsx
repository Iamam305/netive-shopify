      ...
      <div className="flex flex-col w-full my-4 md:flex-row-reverse md:w-3/4 items-center justify-center mx-auto  rounded-2xl shadow-2xl md:p-12 bg-white">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-2/5 backdrop-blur-sm bg-white/30 p-6 md:p-1">
          ...
          <span className="flex flex-col my-3">
            ...
            <input type="file" {...register("appIcon")} name="appIcon" id="appIcon" className="ml-2 p-3 pl-0 h-12" onChange={imageChange} />
            <div className='w-full h-14  relative -mt-12 bg-white'></div>
