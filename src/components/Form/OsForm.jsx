...
const schema = yup.object().shape({
    ...
    signingCertificate: yup.mixed().when('IOS', {
        is: true,
        then: yup.mixed().required("please upload your signing certificate").test("type", "please upload valid certificate", function (value) {
            ...
            <div className="flex flex-col w-full md:flex-row-reverse md:w-3/4 items-center justify-center mx-auto my-auto  rounded-2xl shadow-2xl md:p-12 ">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-2/5 backdrop-blur-sm bg-white/30 p-6 md:p-1">
                    ...
                    <span className='my-3 mb-6 flex flex-col'>
                        ...
                        <p className='text-xs text-red-600 mt-4'>{(android === false && ios === false) ? "please select atleast one platform" : ""}</p>
                    ...
                    {android ? (<>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="fullName" className='text-gray-600 mb-2 font-bold'>Full Name</label>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="fullName" className='text-gray-600 mb-2 font-bold'>Your Organization</label>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="keyAlias" className='text-gray-600 mb-2 font-bold'>Key Alias</label>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="keystorePass" className='text-gray-600 mb-2 font-bold'>Create Keystore Password</label>
                    ...
                    {ios ? (<>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="signingCertificate" className='text-gray-600 mb-2 font-bold'> Select Signing Certificate</label>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="provisioningProfile" className='text-gray-600 mb-2 font-bold'>  Select Provisioning Profile</label>
                        ...
                        <span className='flex flex-col my-4'>
                            <label htmlFor="iosPassword" className='text-gray-600 mb-2 font-bold'>Password</label>
